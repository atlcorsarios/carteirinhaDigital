...
export const useNotificationsStore = defineStore('notifications', () => {
  ...
  const defaultNotificationsTest: Partial<INotification>[] = [
    ...
    },
    {
      ...
      message:
        'Separação entre as mensagens visualizadas e não visualizadas, isso é por usuário então deve ter um controle (deixar para quando tiver o banco, será mais fácil)',
      seen: true,
      sender: 'Usuário.ficticio@gmail.com',
      recipients: ['avelito@gmail.com'],
    },
